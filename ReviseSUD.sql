...
Select
    ...
    , CASE WHEN DAYS_BETWEEN(A0."U_INDATE", :DF ) BETWEEN 61 AND 90 THEN 1 ELSE 0 END AS "61-90_Days"
    , CASE WHEN DAYS_BETWEEN(A0."U_INDATE", :DF ) BETWEEN 91 AND 120 THEN 1 ELSE 0 END AS "91-120_Days"
    , CASE WHEN DAYS_BETWEEN(A0."U_INDATE", :DF )> 120 THEN 1 ELSE 0 END AS "Over-120_Days"
